...
| Guide | Use it for |
| --- | --- |
| [Configuration and named boards](configuration.md) | XDG and legacy paths, portable mode, limits and config commands |
...
| [Python API compatibility](python-api.md) | Canonical modules and the `1.0.0` legacy removal plan |
